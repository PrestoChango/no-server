angular.module('noServer').service('serv', function ($http) {
  ...
  this.pushData = function(name, movie, review, date, score) {
    reviews.push({movie: movie, critic: name, review: review, reviewDate: date, score: score})
  }
